namespace ASTM.SQL
{
    ...
    public class  ASTMContainer
    {
        ...
        public void GetAllFileDir()
        {
            ...
            DirectoryInfo d = new DirectoryInfo(startupPath + ASTMGlobal.getValue("pathSQL"));//.ToUpper()].ToString());
            FileInfo[] Files = d.GetFiles(ASTMGlobal.getValue("FileType"));//.ToUpper()].ToString());
