...
namespace ASTM
{
    ...
    public class ASTM_Manufacturer : ASTM_Record
    {
        ...
        public override List<ASTM_Record> comments()
        {
            return commentRecords.ToList<ASTM_Record>();
        }
    ...
    public class ASTM_Message : ASTM_Record
    {
        ...
        public override List<ASTM_Record> manufacturerInfo()
        {
            return manufacturerRecords.ToList<ASTM_Record>();
        }
    ...
    public class ChiTietKetQuaXetNghiem_CellDyn3200
    {
        #region Fields
    ...
    public class KetQuaXetNghiem
    {
        ...
        public string CollectionDate; // arrResult[15].Trim();
        public string CollectionTime; // arrResult[16].Trim();
        public string Comment; // arrResult[17].Trim();
        public string DrName; // arrResult[11].Trim();
        public string InstrumentType; // arrResult[1].Trim();
        public string MessageType; // (object)arrResult[0].Trim().Substring (1);
        public DateTime NgayXN; // DateTime.ParseExact(string .Format("{0} {1}", arrResult[13].Trim(), arrResult[14].Trim()),
        public string OperatorID; // arrResult[12].Trim();
        public string PatientID; // arrResult[8].Trim();
        public int SequenceNum; // Convert.ToInt32(arrResult[3].Trim());
        public string SerialNum; // arrResult[2].Trim();
        public string SpareField; // arrResult[4].Trim();
        public string SpecimenDOB; // arrResult[10].Trim();
        public string SpecimenID; // arrResult[6].Trim();
        public string SpecimenName; // arrResult[7].Trim();
        public string SpecimenSex; // arrResult[9].Trim();
        public int SpecimenType; // Convert.ToInt32(arrResult[5].Trim());
    ...
    public class Parser
    {
        ...
        public static void parse(String astmData, ref List<object> messages)
        {
            //List<ASTM_Message>
            ...
            foreach (var l in lines)
            {
                ...
                switch (entries.ElementAt(0))
                {
                    case "H":
                        ...
                        m = (messages .Last() as ASTM_Message);
                        curRec = m;
                        curRec.parseData(l);
                        break;
                    case "P":
    ...
    public class TestResult_CellDyn3200
    {
        ...
        private KetQuaXetNghiem _ketQuaXetNghiem = new KetQuaXetNghiem();
        ...
        public KetQuaXetNghiem KetQuaXetNghiem
        {
        ...
        public static class Parser
        {
            ...
            public static void parse(String astmData, ref List<ASTM_Message> messages)
            {
                var lines = Regex.Split(astmData, "\r\n|\r|\n");
                ASTM_Message m = null;
                ASTM_Record curRec = null;
